Package.describe({
    ...
    version: "1.0.1",
    name: "jss:accounts-azure-active-directory",
    git: "https://github.com/JSSolutions/accounts-azure-active-directory"
});
...
Package.onUse(function(api) {
    ...
    api.use('jss:azure-active-directory@1.0.1', ['client', 'server']);
